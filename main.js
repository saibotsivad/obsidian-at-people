...
// src/suggesters/FileSuggester.js
var FileSuggester_default = class extends TextInputSuggest {
...
var NAME_REGEX = /\/@([^\/]+)\.md$/;
var LAST_NAME_REGEX = /([\S]+)$/;
var getPersonName = (filename, settings) => {
  var _a;
...
module.exports = class AtPeople extends import_obsidian4.Plugin {
  constructor() {
    ...
    __publicField(this, "update", async ({ path, deleted, ...remaining }, originalFilepath) => {
...
var AtPeopleSuggestor = class extends import_obsidian4.EditorSuggest {
  ...
  onTrigger(cursor, editor, tFile) {
    ...
    if (query && !query.includes("]]") && // if it's an @ at the start of a line
  ...
  renderSuggestion(value, elem) {
    if (value.suggestionType === "create")
      elem.setText("New person: " + value.displayText);
    else
